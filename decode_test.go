...
var wrongStringTests = []wrongStringTest{
	{`{"result":"x"}`, `xjson: invalid use of ,string struct tag, trying to unmarshal "x" into string`},
	{`{"result":"foo"}`, `xjson: invalid use of ,string struct tag, trying to unmarshal "foo" into string`},
	{`{"result":"123"}`, `xjson: invalid use of ,string struct tag, trying to unmarshal "123" into string`},
}
